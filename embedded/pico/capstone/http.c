...
#define TLS_CLIENT_SERVER "192.168.137.38"
// #define TLS_CLIENT_HTTP_REQUEST  "GET /api/scale HTTP/1.1\r\n" \
//                                  "Host: " TLS_CLIENT_SERVER "\r\n" \
//                                  "Connection: close\r\n" \
//                                  "\r\n"
#define TLS_CLIENT_TIMEOUT_SECS  15

#define SERIAL_NUMBER "SPCAS67DKG1CP3G"

char TLS_CLIENT_HTTP_REQUEST[200];
...
void generateHTTPFormat(char* scaleid, float weight) {
    ...
    uint16_t content_length = strlen(json_payload);

    sprintf(TLS_CLIENT_HTTP_REQUEST,    
    "PUT /api/scale/%s HTTP/1.1\r\n"
        "Host: " TLS_CLIENT_SERVER "\r\n"
